...
public class ChallengeManager {
    ...
    public static boolean makeChallenge(int challengerId, int opponentId, String mode, String status, int challengerScore,int opponentScore, int winnerId) {
    	Challenge challenge = null;
    	try {
			challenge = new Challenge(challengerId, opponentId, mode, status, challengerScore, opponentScore, winnerId);
			return challengeDao.makeChallenge(challenge);
		} catch (Exception e) {
