...
//	-----------------------------  -------- Leaderboard  ------- -----------------------------------------------------
	...
	public static final String VIEW_LEADERBOARD = "SELECT l.leaderboard_id, l.user_id, u.username, l.map_id, l.mode_id,        l.total_score, l.total_games, l.average_score, l.rank_position FROM leaderboard l JOIN USERS u ON u.users_id = l.user_id;";
	public static final String VIEW_TOPFIVE_LEADERBOARD="SELECT l.leaderboard_id, l.user_id, u.username, l.map_id, l.mode_id,        l.total_score, l.total_games, l.average_score, l.rank_position FROM leaderboard l JOIN USERS u ON u.users_id = l.user_id limit=5";
